...
public class SM2PrivateKey extends BCECPrivateKey {
    ...
    public SM2PrivateKey(BCECPrivateKey privateKey, BCECPublicKey publicKey) {
        ...
        this.sm2PublicKey = getSM2PublicKeyDetails(
                new SM2PublicKey(publicKey.getAlgorithm(), publicKey));
    ...
    public byte[] getEncoded() {
        ...
        if (sm2PublicKey != null) {
            keyStructure = new ECPrivateKey(orderBitLength, this.getS(), sm2PublicKey, params);
        } else {
