...
//                    "target/ec2.x509.pub.der");
            ...
            byte[] encryptedData = SM2Util.encrypt(pubKey, en.getBytes());
...
//            }
    ...
    public void testSM2KeyRecovery() {
        try {
            ...
            String encodedPubHex = "04FF6712D3A7FC0D1B9E01FF471A87EA87525E47C7775039D19304E55" +
                    "4DEFE0913F632025F692776D4C13470ECA36AC85D560E794E1BCCF53D82C015988E0EB956";
            String signHex = "30450220213C6CD6EBD6A4D5C2D0AB38E29D441836D1457A8118D34864C247D72" +
                    "7831962022100D9248480342AC8513CCDF0F89A2250DC8F6EB4F2471E144E9A812E0AF497F801";
            byte[] signBytes = ByteUtils.fromHexString(signHex);
            byte[] src = ByteUtils.fromHexString("010203040506070801020304050607080102030405060" +
                    "7080102030405060708");
    ...
    public void testEncodeSM2CipherToDER_C1C2C3() {
        try {
            ...
            byte[] decryptedData =
                    SM2Util.decrypt(Mode.C1C2C3, priKey, SM2Util.decodeDERSM2Cipher(Mode.C1C2C3, derCipher));
            if (!Arrays.equals(decryptedData, SRC_DATA)) {
                Assert.fail();
            }
