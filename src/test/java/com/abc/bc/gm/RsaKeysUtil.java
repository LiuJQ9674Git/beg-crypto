...
public class RsaKeysUtil{
    ...
    public static void main(String[] args) throws Exception {
        ...
        //
        byte[] bytes=decryptBASE64("MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDdPWI03fnUgyMtEK7nWOW5RhfFZktYVSN16JN9\n" +
                "uFwL7Ng75iOj6MmEaMUDUFmHvV0SPC8GsyjCxEdokFXaLC4D22tQj1HUkdlSx7sm5oOMMzskAaMV\n" +
                "NJi+u31iBTQkPMq4+pOHchieJFpgUBcZZxyz10RJMSntb9VqfoyKgpUAdwIDAQAB");

        System.out.println("生成的公钥decryptBASE64=>" + new String(bytes));
