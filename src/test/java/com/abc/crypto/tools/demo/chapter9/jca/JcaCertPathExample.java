package com.abc.crypto.tools.demo.chapter9.jca;
...
import static com.abc.crypto.tools.demo.chapter8.certificates.JcaX509Certificate.createEndEntity;
...
public class JcaCertPathExample
{
        ...
        throws Exception
    {
        ...
        X509CRL trustCRL = crlConverter.getCRL(
            JcaX509CRL.createEmptyCRL(trustKp.getPrivate(), "SHA256withECDSA", trustHldr));
        X509CRL caCRL = crlConverter.getCRL(
            JcaX509CRL.createEmptyCRL(caKp.getPrivate(), "SHA256withECDSA", caHldr));
